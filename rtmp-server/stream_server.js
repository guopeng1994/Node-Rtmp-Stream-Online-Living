...
(function() {
  var Bits, CustomReceiver, DEBUG_INCOMING_PACKET_DATA, DEBUG_INCOMING_PACKET_HASH, DEFAULT_SERVER_NAME, Sequent, StreamServer, aac, avstreams, config, crypto, fs, h264, logger, mp4, net, packageJson, ref, rtmp, serverName;
 ...
 // CustomReceiver = require('./custom_receiver');
  ...
  DEFAULT_SERVER_NAME = "rtmp-server/" + packageJson.version;
